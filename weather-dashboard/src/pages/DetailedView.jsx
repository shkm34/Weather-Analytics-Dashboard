    ...
    <>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-8 mb-8">
          {/* Temperature Trends */}
          <TemperatureChart
            data={prepareTempData(forecast.forecastday, tempUnit)}
            tempUnit={tempUnit}
          />

          {/* Precipitation - Today only */}
          <PrecipitationChart
            data={preparePrecipitationData(forecast.forecastday[0].hour)}
          />

          {/* Wind Speed - Today only */}
          <WindChart data={prepareWindData(forecast.forecastday[0].hour)} />
        </div>
            ...
            <div className="flex gap-4 pb-4">
              {forecast.forecastday[0].hour.map((hour) => {
                ...
                return (
                  <div
                    key={hour.time}
                    className="flex flex-col items-center min-w-20 p-3 bg-gray-50 rounded-lg"
                  >
